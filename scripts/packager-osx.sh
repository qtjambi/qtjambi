...
export QTDIR=/users/Bruno/qt-everywhere-opensource-src-4.6.0
export RELEASE=qtjambi-macosx32-intel-community-4.6.0
...
cp qtjambi-4.6.0.jar $RELEASE
cp qtjambi-designer-4.6.0.jar $RELEASE
cp qtjambi-examples-4.6.0.jar $RELEASE
cp qtjambi-util-4.6.0.jar $RELEASE
cp qtjambi-macosx-gcc-4.6.0.jar $RELEASE
    
cp dist/mac/qtjambi.sh $RELEASE
cp dist/mac/designer.sh $RELEASE
cp dist/set_qtjambi_env.sh $RELEASE

cp dist/changes-4.6.0_01 $RELEASE 
...
cp lib/libcom_trolltech_qt_core.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_gui.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_network.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_opengl.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_phonon.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_sql.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_svg.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_webkit.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_xml.jnilib $RELEASE/lib
cp lib/libcom_trolltech_qt_xmlpatterns.jnilib $RELEASE/lib
cp lib/libcom_trolltech_tools_designer.jnilib $RELEASE/lib
