/****************************************************************************
**
** Copyright (C) 2010 Peter Droste. All rights reserved.
**
** This file is part of Pedro79s Qt Jambi.
**
** ** $BEGIN_LICENSE$
...
public class PlatformSpecificFunctions {
     ...
     * @param widget
     */
    public static void qt_x11_wait_for_window_manager(QWidget widget){
     ...
     * @param enable
     */
    public static void qt_mac_secure_keyboard(boolean enable){
     ...
     * @param menu
     */
    public static void qt_mac_set_dock_menu(QMenu menu){
     ...
     * @param enable
     */
    public static void qt_mac_set_menubar_icons(boolean enable){
     ...
     * @param enable
     */
    public static void qt_mac_set_menubar_merge(boolean enable){
     ...
     * @param enable
     */
    public static void qt_mac_set_native_menubar(boolean enable){
     ...
     * @param enable
     */
    public static void qt_mac_set_press_and_hold_context(boolean enable){
    	__qt_mac_set_press_and_hold_context(enable);
	}
    
    
    private static native void __qt_set_library_config_file(String fileName);
    private static native void __qt_set_sequence_auto_mnemonic(boolean enable);
