...
OutFile "setup-qt-jambi-${v}-win${arq}-${comp}${VersionSuffix}.exe"; The file to write
...
File ..\..\build\qtjambi-native-win${arq}-${comp}-${v}.jar
...
File /r ..\..\build\platform-output\lib\*.dll
...
; Jambi Qt Designer Plugins
File ..\..\build\platform-output\plugins-designer\designer\JambiCustomWidget.dll
File ..\..\build\platform-output\plugins-designer\designer\JambiLanguage.dll

SetOutPath $INSTDIR\plugins\qtjambi
File /r ..\..\build\platform-output\plugins-designer\qtjambi\*.xml
...
Delete $INSTDIR\qtjambi-native-win${arq}-${comp}-${v}.jar
