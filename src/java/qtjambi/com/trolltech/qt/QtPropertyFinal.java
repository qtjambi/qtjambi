...
/**
 * The presence of the QtPropertyFinal annotation indicates that
 * the property will not be overridden by a derived class.  This can
 * be used for performance optimizations in some cases, but is not
 * enforced by moc.  Care must be taken never to override a FINAL
 * @QtPropertyFinal property.
 *
 */
@Retention(RetentionPolicy.RUNTIME)
public @interface QtPropertyFinal {
    /**
