...
/**
 * QtPropertyNotify signal name is optional.
 * If defined, it should specify one existing signal in that class
 * that is emitted whenever the value of the property changes.
 */
@Retention(RetentionPolicy.RUNTIME)
public @interface QtPropertyNotify {
    /**
     * The value should specify one existing signal in that class
     * that is emitted emitted whenever the value of the property
     * changes.
     */
