 ...
 * should be thought of as existing on its own or as depending on other values.
 * It also indicates whether the property value must be saved when storing the
 * object's state.  Most properties are STORED (default true).
 *
 */
