...
#include <jni.h>
/* Header for class com_trolltech_qt_PlatformSpecificFunctions */

#ifndef _Included_com_trolltech_qt_PlatformSpecificFunctions
#define _Included_com_trolltech_qt_PlatformSpecificFunctions
#ifdef __cplusplus
extern "C" {
#endif
/*
