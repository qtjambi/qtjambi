...
static QStringList includePaths()
{
    ...
    incs << qtDir() + QLatin1String("/include")
         << qtDir() + QLatin1String("/include/QtCore")
         << qtDir() + QLatin1String("/include/QtGui")
         << qtDir() + QLatin1String("/include/QtSql")
         << qtDir() + QLatin1String("/include/QtNetwork")
         << qtDir() + QLatin1String("/include/QtOpenGL")
         << qtDir() + QLatin1String("/include/QtXml")
         << qtDir() + QLatin1String("/include/QtSvg");
    return incs;
}
...
{
    QStringList hdrs;
    hdrs << qtDir() + QLatin1String("/include/QtCore/QtCore")
         << qtDir() + QLatin1String("/include/QtGui/QtGui")
         << qtDir() + QLatin1String("/include/QtSql/QtSql")
         << qtDir() + QLatin1String("/include/QtNetwork/QtNetwork")
         << qtDir() + QLatin1String("/include/QtOpenGL/QtOpenGL")
         << qtDir() + QLatin1String("/include/QtXml/QtXml")
         << qtDir() + QLatin1String("/include/QtSvg/QtSvg");
    return hdrs;
}
