...
import com.trolltech.qt.core.QAbstractFileEngineHandler;
...
class QClassPathEngine extends QAbstractFileEngine
{
    ...
    {
        String qtified_path = path.replace(System.getProperty("file.separator"), "/");
        ...
        if (file.isDir() 
            ...
            JarFile jarFile;
            try {
                jarFile = new JarFile(path.replace("/", System.getProperty("file.separator")));                
            } catch (IOException e) {
                return ;
            }
