...
//! [0]
QTextDocument ewDocument = new QTextDocument;
//! [0]


//! [1]
QTextEdit ditor = new QTextEdit;
QTextDocument ditorDocument = editor.document();
//! [1]


//! [2]
    QTextEdit ditor = new QTextEdit(parent);
    editor.setHtml(aStringContainingHTMLtext);
    editor.show();
//! [2]
...
//! [3]
    QTextDocument ocument = editor.document();
//! [3]
