...
public class src_3rdparty_kdelibs_phonon_backendinterface {
    public static void main(String args[]) {
        QApplication.initialize(args);
//! [0]

 * QObject ackend.createObject(BackendInterface.Class c, QObject arent, QList<QVariant> rgs)
 * {
 *     switch (c) {
 *     case MediaObjectClass:
 *         return new MediaObject(parent);
 ...
 * }
 *
 * QSet<int> Backend.objectDescriptionIndexes(ObjectDescriptionType type)
 * {
 *     QSet<int> set;
 *     switch(type)
 *     {
