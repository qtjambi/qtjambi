/*   Ported from: src.corelib.tools.qbytearray.cpp
<snip>
//! [0]
        QByteArray ba("Hello");
//! [0]
...
//! [36]
        QByteArray str("FF");
        booleansok;
        int hex = str.toInt(k, 16);     // hex == 255, ok == true
        int dec = str.toInt(k, 10);     // dec == 0, ok == false
//! [36]
...
//! [37]
        QByteArray str("FF");
        booleansok;
        long hex = str.toLong(k, 16);   // hex == 255, ok == true
        long dec = str.toLong(k, 10);   // dec == 0, ok == false
//! [37]
...
//! [43]
        ...
        QByteArray data = QByteArray.fromRawData(mydata, sizeof(mydata));
        QDataStream in(ata, QIODevice.ReadOnly);
        ...
//! [43]
